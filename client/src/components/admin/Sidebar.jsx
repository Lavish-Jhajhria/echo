...
import { ChevronLeft, ChevronRight, LayoutDashboard, MessageSquare, Users, Flag, FileText } from 'lucide-react';
...
const navItems = [
  ...
  { id: 'audit', label: 'Audit Log', icon: FileText, to: '/admin/audit' }
];
